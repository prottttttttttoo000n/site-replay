import type { SessionResponse, SessionsListResponse } from "../types";
...
export function watchSession(sessionId: string, onEvents: (events: Record<string, unknown>[]) => void): WebSocket {
